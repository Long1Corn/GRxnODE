...
def get_dataset(data_dir, f=5, s=1, scale=None):
    ...
    if scale is None:
        scale = [data_mean[3:], data_std[3:]]

    data_output = np.expand_dims(data_output, axis=1)
    data_output = (data_output[:, 0:1, 3:]) / scale[0]
...
def get_data(f=5, s=1, data=""):
    train_dir = r"/home/pengfei/projects/neural_ode/TheoryGuidedRNN/dataset/CSTR_2_train"
    test_dir = r"/home/pengfei/projects/neural_ode/TheoryGuidedRNN/dataset/CSTR_2_test"
